...
export type Mode = 'imageQuiz' | 'spellingQuiz' | 'meaningQuiz' | 'pronunciation' | 'combinedQuiz' | 'listeningQuiz' | 'spellingGame' | 'fillBlankGame' | 'sentenceGame' | 'bossRaid' | 'memoryGame' | 'speedChallenge';
